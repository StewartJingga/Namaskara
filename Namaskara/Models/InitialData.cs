    ...
    public class InitialData : DropCreateDatabaseIfModelChanges<NamaskaraDb>
    {
        protected override void Seed(NamaskaraDb context)
        {
            ...
            List<Product> Products = new List<Product>
            {
                ...
                new Product { Name =  "BRAGGS Apple Cider Vinegar Organic", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), ImageUrl = "BRAGGS apple cider vinegar", Origin = ""},
                ...
                new Product { Name =  "Kuranda Muesli - Berry Blend w/ Amarath", Category = Categories.Single(c => c.Name == "Crackers & Snacks"), ImageUrl = "kuranda muesli - berry blend", Origin = ""},
                ...
                new Product { Name =  "DR. Broners Liquid Soap Citrus Orange", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Lavender", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Eucalyptus", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Almond", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Peppermint", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Tea Tree", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Baby Mild", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Rose", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners liquid soap", Origin = ""},
