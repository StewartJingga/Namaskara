...
namespace Namaskara.Models
{
    public class InitialData : DropCreateDatabaseIfModelChanges<NamaskaraDb>
    {
        protected override void Seed(NamaskaraDb context)
        {
            ...
            {
                new Product { Name =  "Alfalfa Seed Natural", Category = Categories.Single(c => c.Name == "Seeds & Grains"), ImageUrl = "alfafa seed organic", Origin = ""},
                ...
                new Product { Name =  "Lecithin Granules Natural", Category = Categories.Single(c => c.Name == "Seeds & Grains"), ImageUrl = "lecithin granule", Origin = ""},
                new Product { Name =  "Lecithine Granules Organic", Category = Categories.Single(c => c.Name == "Seeds & Grains"), ImageUrl = "lecithin granule", Origin = ""},
                ...
                new Product { Name =  "Macadamia Nuts Natural", Category = Categories.Single(c => c.Name == "Beans"), ImageUrl = "macadamia nuts", Origin = ""},
                ...
                new Product { Name =  "Umiboshi Plum Ball", Category = Categories.Single(c => c.Name == "Dried Fruits"), IsAvailable = false, ImageUrl = "umbeboshi (plum ball) - dried", Origin = ""},
                new Product { Name =  "Umiboshi with Red Shiso Leaf", Category = Categories.Single(c => c.Name == "Dried Fruits"), IsAvailable = false, ImageUrl = "", Origin = ""},
                ...
                new Product { Name =  "EDEN - Cranberries", Category = Categories.Single(c => c.Name == "Dried Fruits"), ImageUrl = "dried cranberries", Origin = ""},

                new Product { Name =  "Corn Semolina Organic", Category = Categories.Single(c => c.Name == "Food Products"), ImageUrl = "corn semolina", Origin = ""},
                new Product { Name =  "Couscous Whole Wheat Organic", Category = Categories.Single(c => c.Name == "Food Products"), ImageUrl = "whole wheat couscous", Origin = ""},
                ...
                new Product { Name =  "Crust Margarine Organic", Category = Categories.Single(c => c.Name == "Food Products"), IsAvailable = false, ImageUrl = "", Origin = ""},
                new Product { Name =  "Maca Powder Organic", Category = Categories.Single(c => c.Name == "Food Products"), ImageUrl = "maca powder", Origin = ""},
                new Product { Name =  "Pastry Margarine Organic", Category = Categories.Single(c => c.Name == "Food Products"), IsAvailable = false, ImageUrl = "", Origin = ""},
                new Product { Name =  "Tapioca Pearls Organic", Category = Categories.Single(c => c.Name == "Food Products"), IsAvailable = false, ImageUrl = "", Origin = ""},
                ...
                new Product { Name =  "Potato Starch Organic", Category = Categories.Single(c => c.Name == "Flour"), ImageUrl = "potato starch", Origin = ""},
                new Product { Name =  "Maniooc Starch Organic", Category = Categories.Single(c => c.Name == "Flour"), ImageUrl = "manioc startch", Origin = ""},
                ...
                new Product { Name =  "Barley Flour Organic", Category = Categories.Single(c => c.Name == "Flour"), ImageUrl = "barley flour organic", Origin = ""},
                ...
                new Product { Name =  "Muesli Blueberry Organic", Category = Categories.Single(c => c.Name == "Oats"), ImageUrl = "blueberry muesli organic", Origin = ""},
                ...
                new Product { Name =  "Edensoy Carob", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "edensoy carob", Origin = ""},
                new Product { Name =  "Edensoy Chocolate", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "edensoy choc", Origin = ""},
                new Product { Name =  "Edensoy Vanilla", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "edensoy vanilla", Origin = ""},
                new Product { Name =  "Edensoy Extra Vanilla", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "edensoy vanilla extra", Origin = ""},
                new Product { Name =  "Edensoy Blend Rice & Soy", Category = Categories.Single(c => c.Name == "Milk"), IsAvailable = false, Packaging = PackagingEnum.Carton, ImageUrl = "", Origin = ""},
                new Product { Name =  "Edensoy Extra Original", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "edensoy extra original", Origin = ""},
                new Product { Name =  "PURE HARVEST (Oat Milk)", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "pure harvest oat milk", Origin = ""},
                new Product { Name =  "PURE HARVEST (Brown Rice Milk)", Category = Categories.Single(c => c.Name == "Milk"), IsAvailable = false, Packaging = PackagingEnum.Carton, ImageUrl = "", Origin = ""},
                new Product { Name =  "Bonsoy", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "bonsoy", Origin = ""},

                new Product { Name =  "RBD Coconut Oil", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), Packaging = PackagingEnum.Bottle, ImageUrl = "RBD coconut poil", Origin = ""},
                new Product { Name =  "Tamari Organic USA", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), IsAvailable = false , Packaging = PackagingEnum.Bottle, ImageUrl = "", Origin = ""},
                new Product { Name =  "NG Tamari Organic", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), Packaging = PackagingEnum.Bottle, ImageUrl = "tamari sauce - NG", Origin = ""},
                new Product { Name =  "Tamari Organic", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), IsAvailable = false , Packaging = PackagingEnum.Bottle, ImageUrl = "", Origin = ""},
                new Product { Name =  "NG Sesame Oil Toasted", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), Packaging = PackagingEnum.Bottle, ImageUrl = "sesame oil toasted - NG", Origin = ""},
                new Product { Name =  "Sesame Oil Extra Virgin Org", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), Packaging = PackagingEnum.Bottle, ImageUrl = "sesame oil extra virgin", Origin = ""},
                new Product { Name =  "NG Sesame Oil (light)", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), Packaging = PackagingEnum.Bottle, ImageUrl = "sesame oil light", Origin = ""},
                new Product { Name =  "Sesame Oil Toasted", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), IsAvailable = false ,Packaging = PackagingEnum.Bottle, ImageUrl = "", Origin = ""},
                new Product { Name =  "NG Shoyu Organic", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), Packaging = PackagingEnum.Bottle, ImageUrl = "shoyu - NG", Origin = ""},
                new Product { Name =  "NG Shoyu Organic Low Salt", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), Packaging = PackagingEnum.Bottle, ImageUrl = "shoyu low salt - NG", Origin = ""},
                new Product { Name =  "Shoyu Organic", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), IsAvailable = false ,Packaging = PackagingEnum.Bottle, ImageUrl = "", Origin = ""},
                new Product { Name =  "Shoyu Organic Low Salt", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), IsAvailable = false ,Packaging = PackagingEnum.Bottle, ImageUrl = "", Origin = ""},
                new Product { Name =  "Shoyu USA Organic", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), IsAvailable = false ,Packaging = PackagingEnum.Bottle, ImageUrl = "", Origin = ""},
                new Product { Name =  "BRAGGS Amino Liquid", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), Packaging = PackagingEnum.Bottle, ImageUrl = "BRAGGS amino", Origin = ""},
                new Product { Name =  "BRAGGS Apple Cider Vinegar Organic", Category = Categories.Single(c => c.Name == "Oil & Vinegar"), Packaging = PackagingEnum.Bottle, ImageUrl = "BRAGGS apple cider vinegar", Origin = ""},
                ...
                new Product { Name =  "Organic Blend Rice (3 Grain)", Category = Categories.Single(c => c.Name == "Rice"), ImageUrl = "3 grain rice", Origin = ""},
                ...
                new Product { Name =  "White Rice Short Organic", Category = Categories.Single(c => c.Name == "Rice"), ImageUrl = "white rice short grain", Origin = ""},
                ...
                new Product { Name =  "Atlantik Sea Salt Extra Fine #1", Category = Categories.Single(c => c.Name == "Salt"), ImageUrl = "atlantic sea salt extra fine", Origin = ""},
                ...
                new Product { Name =  "Canesugar Uni Light Organic", Category = Categories.Single(c => c.Name == "Sweeteners"), ImageUrl = "cane sugar light organic", Origin = ""},
                ...
                new Product { Name =  "Blackstrap Molasses Liquid Natural", Category = Categories.Single(c => c.Name == "Sweeteners"), ImageUrl = "blackstrap molasses liquid organic", Origin = ""},
                new Product { Name =  "Blackstrap Molasses Liquid Organic", Category = Categories.Single(c => c.Name == "Sweeteners"), ImageUrl = "blackstrap molasses liquid organic", Origin = ""},
                new Product { Name =  "Orange Sugar Natural", Category = Categories.Single(c => c.Name == "Sweeteners"), ImageUrl = "orange sugar", Origin = ""},
                new Product { Name =  "Barley Malt Organic", Category = Categories.Single(c => c.Name == "Sweeteners"), Packaging = PackagingEnum.Bottle, ImageUrl = "barley malt - organic", Origin = ""},
                new Product { Name =  "Maple Syrup Organic", Category = Categories.Single(c => c.Name == "Sweeteners"), Packaging = PackagingEnum.Bottle, ImageUrl = "maple syrup", Origin = ""},
                new Product { Name =  "Agave Syrup (light)", Category = Categories.Single(c => c.Name == "Sweeteners"), Packaging = PackagingEnum.Bottle, ImageUrl = "agave syrup", Origin = ""},
                ...
                new Product { Name =  "Kuranda Chia Nut & Berry", Category = Categories.Single(c => c.Name == "Crackers & Snacks"), ImageUrl = "kurandachia-berry", Origin = ""},
                new Product { Name =  "Kuranda Chia Cacao Nibs", Category = Categories.Single(c => c.Name == "Crackers & Snacks"), ImageUrl = "kuranda-chiacacao", Origin = ""},
                ...
                new Product { Name =  "Mungbeans Chip Muso", Category = Categories.Single(c => c.Name == "Crackers & Snacks"), ImageUrl = "mungbeans chip muso", Origin = ""},
                ...
                new Product { Name =  "Spirulina Flakes", Category = Categories.Single(c => c.Name == "Vitamins & Supplements"), ImageUrl = "spirulina flakes", Origin = ""},
                ...
                new Product { Name =  "DR. Broners Liquid Soap Citrus Orange", Category = Categories.Single(c => c.Name == "Toiletries"), Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Lavender", Category = Categories.Single(c => c.Name == "Toiletries"), Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Eucalyptus", Category = Categories.Single(c => c.Name == "Toiletries"), Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Almond", Category = Categories.Single(c => c.Name == "Toiletries"), Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Peppermint", Category = Categories.Single(c => c.Name == "Toiletries"), Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Tea Tree", Category = Categories.Single(c => c.Name == "Toiletries"), Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Baby Mild", Category = Categories.Single(c => c.Name == "Toiletries"), Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Liquid Soap Rose", Category = Categories.Single(c => c.Name == "Toiletries"), Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners liquid soap", Origin = ""},
                new Product { Name =  "DR. Broners Soap Bar Citrus Orange", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners magic soap", Origin = ""},
                new Product { Name =  "DR. Broners Soap Bar Lavender", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners magic soap", Origin = ""},
                new Product { Name =  "DR. Broners Soap Bar Eucalyptus", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners magic soap", Origin = ""},
                new Product { Name =  "DR. Broners Soap Bar Almond", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners magic soap", Origin = ""},
                new Product { Name =  "DR. Broners Soap Bar Peppermint", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners magic soap", Origin = ""},
                new Product { Name =  "DR. Broners Soap Bar Tea Tree", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners magic soap", Origin = ""},
                new Product { Name =  "DR. Broners Soap Bar Baby Mild", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners magic soap", Origin = ""},
                new Product { Name =  "DR. Broners Soap Bar Rose", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners magic soap", Origin = ""},
                new Product { Name =  "DR. Broners Lotion", Category = Categories.Single(c => c.Name == "Toiletries"), IsAvailable = false, Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners magic lotion", Origin = ""},
                new Product { Name =  "DR. Broners Skin & Tattoo Balm", Category = Categories.Single(c => c.Name == "Toiletries"), IsAvailable = false, ImageUrl = "dr bronners body balm", Origin = ""},
                ...
                new Product { Name =  "Vicco Toothpaste", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "vicco toothpaste", Origin = ""}
            ...
            new List<Item>
            {
                ...
                new Item { Name = "Lecithin Granules Natural", Size = "500 g", RetailPrice = 283900M, IsAvailable = true, Product = Products.Single(m => m.Name == "Lecithin Granules Natural") },
                new Item { Name = "Lecithin Granules Natural", Size = "200 g", RetailPrice = 82450M, IsAvailable = true, Product = Products.Single(m => m.Name == "Lecithin Granules Natural") },
                ...
                new Item { Name = "Chestnut Dried", Size = "0 g", RetailPrice = 0M, IsAvailable = true, Product = Products.Single(m => m.Name == "Chestnut Dried") },
                ...
                new Item { Name = "Navy Beans Organic(Canned)", Size = "425 g", RetailPrice = 37400M, IsAvailable = true, Product = Products.Single(m => m.Name == "Navy Beans Organic(Canned)") },
                new Item { Name = "Pinto Beans Organic(Canned)", Size = "398 ml", RetailPrice = 37400M, IsAvailable = true, Product = Products.Single(m => m.Name == "Pinto Beans Organic(Canned)") },
                ...
                new Item { Name = "Umiboshi Plum Ball", Size = "10 kg", RetailPrice = 6603000M, IsAvailable = false, Product = Products.Single(m => m.Name == "Umiboshi Plum Ball") },
                new Item { Name = "Umiboshi with Red Shiso Leaf", Size = "1 kg", RetailPrice = 939750M, IsAvailable = false, Product = Products.Single(m => m.Name == "Umiboshi with Red Shiso Leaf") },
                ...
                new Item { Name = "Bonsoy", Size = "1 ltr", RetailPrice = 92000M, IsAvailable = true, Product = Products.Single(m => m.Name == "Bonsoy") },
                ...
                new Item { Name = "Tamari Organic USA", Size = "5 ltr", RetailPrice = 733250M, IsAvailable = false, Product = Products.Single(m => m.Name == "Tamari Organic USA") },
                ...
                new Item { Name = "NG Tamari Organic", Size = "5 ltr", RetailPrice = 1285950M, IsAvailable = false, Product = Products.Single(m => m.Name == "NG Tamari Organic") },

                new Item { Name = "Tamari Organic", Size = "20 ltr", RetailPrice = 5766550M, IsAvailable = false, Product = Products.Single(m => m.Name == "Tamari Organic") },
                ...
                new Item { Name = "NG Sesame Oil (light)", Size = "650 ml", RetailPrice = 278950M, IsAvailable = true, Product = Products.Single(m => m.Name == "NG Sesame Oil (light)") },

                new Item { Name = "Sesame Oil Toasted", Size = "10 ltr", RetailPrice = 3592150M, IsAvailable = false, Product = Products.Single(m => m.Name == "Sesame Oil Toasted") },
                ...
                new Item { Name = "Shoyu Organic", Size = "20 ltr", RetailPrice = 4651100M, IsAvailable = false, Product = Products.Single(m => m.Name == "Shoyu Organic") },
                new Item { Name = "Shoyu Organic Low Salt", Size = "20 ltr", RetailPrice = 4803150M, IsAvailable = false, Product = Products.Single(m => m.Name == "Shoyu Organic Low Salt") },
                new Item { Name = "Shoyu USA Organic", Size = "5 ltr", RetailPrice = 605100M, IsAvailable = false, Product = Products.Single(m => m.Name == "Shoyu USA Organic") },
                ...
                new Item { Name = "Akita Rice", Size = "1 kg", RetailPrice = 493750M, IsAvailable = true, Product = Products.Single(m => m.Name == "Akita Rice") },
                new Item { Name = "Niigita Rice", Size = "1 kg", RetailPrice = 493750M, IsAvailable = true, Product = Products.Single(m => m.Name == "Niigita Rice") },
                new Item { Name = "Wild Black Rice Organic", Size = "1 kg", RetailPrice = 108250M, IsAvailable = true, Product = Products.Single(m => m.Name == "Wild Black Rice Organic") },

                new Item { Name = "Wild Red Rice", Size = "1 kg", RetailPrice = 91800M, IsAvailable = true, Product = Products.Single(m => m.Name == "Wild Red Rice") },
                new Item { Name = "Organic White Rice", Size = "1 kg", RetailPrice = 114300M, IsAvailable = true, Product = Products.Single(m => m.Name == "Organic White Rice") },
                new Item { Name = "Organic Blend Rice (3 Grain)", Size = "1 kg", RetailPrice = 95300M, IsAvailable = true, Product = Products.Single(m => m.Name == "Organic Blend Rice (3 Grain)") },
                ...
                new Item { Name = "Atlantik Sea Salt Course", Product = Products.Single(m => m.Name == "Atlantik Sea Salt Coarse"), Size = "1 kg", RetailPrice = 68650M, IsAvailable = true },
                new Item { Name = "Atlantik Sea Salt Course", Product = Products.Single(m => m.Name == "Atlantik Sea Salt Coarse"), Size = "500 g", RetailPrice = 37750M, IsAvailable = true },
                new Item { Name = "Atlantik Sea Salt Course", Product = Products.Single(m => m.Name == "Atlantik Sea Salt Coarse"), Size = "250 g", RetailPrice = 20800M, IsAvailable = true },
                ...
                new Item { Name = "Spirulina Flakes", Product = Products.Single(m => m.Name == "Spirulina Flakes"), Size = "100 g", RetailPrice = 175500M, IsAvailable = true },
                ...
                new Item { Name = "DR. Broners Liquid Soap Baby Mild", Product = Products.Single(m => m.Name == "DR. Broners Liquid Soap Baby Mild"), Size = "473 ml", RetailPrice = 209919M, IsAvailable = true },
                new Item { Name = "DR. Broners Liquid Soap Baby Mild", Product = Products.Single(m => m.Name == "DR. Broners Liquid Soap Baby Mild"), Size = "236 ml", RetailPrice = 126770M, IsAvailable = true },

                new Item { Name = "DR. Broners Liquid Soap Rose", Product = Products.Single(m => m.Name == "DR. Broners Liquid Soap Rose"), Size = "236 ml", RetailPrice = 136096M, IsAvailable = true },
                ...
                new Item { Name = "DR. Broners Lotion", Product = Products.Single(m => m.Name == "DR. Broners Lotion"), Size = "240 ml", RetailPrice = 195135M, IsAvailable = true },
                new Item { Name = "DR. Broners Skin & Tattoo Balm", Product = Products.Single(m => m.Name == "DR. Broners Skin & Tattoo Balm"), Size = "15 ml", RetailPrice = 100117M, IsAvailable = true },
                new Item { Name = "Chandrika Ayurvedic Soap", Product = Products.Single(m => m.Name == "Chandrika Ayurvedic Soap"), Size = "100 g", RetailPrice = 10854M, IsAvailable = true },

                new Item { Name = "Vicco Toothpaste", Product = Products.Single(m => m.Name == "Vicco Toothpaste"), Size = "200 g", RetailPrice = 84993M, IsAvailable = true },
                new Item { Name = "Vicco Toothpaste", Product = Products.Single(m => m.Name == "Vicco Toothpaste"), Size = "150 g", RetailPrice = 67344M, IsAvailable = true },
                new Item { Name = "Vicco Toothpaste", Product = Products.Single(m => m.Name == "Vicco Toothpaste"), Size = "100 g", RetailPrice = 47883M, IsAvailable = true }
            ...
            new List<City>
            {
                ...
                new City { CityName = "Kabupaten Lamandau", State = States.Single(m => m.StateName == "Kalimantan Tengah") },
                new City { CityName = "Kabupaten Murung Raya", State = States.Single(m => m.StateName == "Kalimantan Tengah") },
                new City { CityName = "Kota Palangka Raya", State = States.Single(m => m.StateName == "Kalimantan Tengah") },
                new City { CityName = "Kabupaten Pulang Pisau", State = States.Single(m => m.StateName == "Kalimantan Tengah") },
                new City { CityName = "Kabupaten Seruyan", State = States.Single(m => m.StateName == "Kalimantan Tengah") },
                new City { CityName = "Kabupaten Sukamara", State = States.Single(m => m.StateName == "Kalimantan Tengah") },
                

                new City { CityName = "Kota Balikpapan", State = States.Single(m => m.StateName == "Kalimantan Timur") },
                new City { CityName = "Kabupaten Berau", State = States.Single(m => m.StateName == "Kalimantan Timur") },
                new City { CityName = "Kota Bontang", State = States.Single(m => m.StateName == "Kalimantan Timur") },
                new City { CityName = "Kabupaten Kutai Barat", State = States.Single(m => m.StateName == "Kalimantan Timur") },
                new City { CityName = "Kabupaten Kutai Kartanegara", State = States.Single(m => m.StateName == "Kalimantan Timur") },
                new City { CityName = "Kabupaten Kutai TImur", State = States.Single(m => m.StateName == "Kalimantan Timur") },
                new City { CityName = "Kabupaten Paser", State = States.Single(m => m.StateName == "Kalimantan Timur") },
                new City { CityName = "Kabupaten Penajam Paser Utara", State = States.Single(m => m.StateName == "Kalimantan Timur") },
                new City { CityName = "Kota Samarinda", State = States.Single(m => m.StateName == "Kalimantan Timur") },
                

                new City { CityName = "Kabupaten Bulungan", State = States.Single(m => m.StateName == "Kalimantan Utara") },
                new City { CityName = "Kabupaten Malinau", State = States.Single(m => m.StateName == "Kalimantan Utara") },
                new City { CityName = "Kabupaten Nunukan", State = States.Single(m => m.StateName == "Kalimantan Utara") },
                new City { CityName = "Kabupaten Tana Tidung", State = States.Single(m => m.StateName == "Kalimantan Utara") },
                new City { CityName = "Kota Tarakan", State = States.Single(m => m.StateName == "Kalimantan Utara") },
                

                new City { CityName = "Kota Batam", State = States.Single(m => m.StateName == "Kepulauan Riau") },
                new City { CityName = "Kabupaten Bintan", State = States.Single(m => m.StateName == "Kepulauan Riau") },
                new City { CityName = "Kabupaten Karimun", State = States.Single(m => m.StateName == "Kepulauan Riau") },
                new City { CityName = "Kabupaten Kepulauan Anambas", State = States.Single(m => m.StateName == "Kepulauan Riau") },
                new City { CityName = "Kabupaten Lingga", State = States.Single(m => m.StateName == "Kepulauan Riau") },
                new City { CityName = "Kabupaten Natuna", State = States.Single(m => m.StateName == "Kepulauan Riau") },
                new City { CityName = "Kota Tanjung Pinang", State = States.Single(m => m.StateName == "Kepulauan Riau") },
                

                new City { CityName = "Kota Bandar Lampung", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Lampung Barat", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Lampung Selatan", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Lampung Tengah", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Lampung Timur", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Lampung Utara", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Mesuji", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Pesawaran", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Pesisir Barat", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Pringsewu", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Tanggamus", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Tulang Bawang", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Tulang Bawang Barat", State = States.Single(m => m.StateName == "Lampung") },
                new City { CityName = "Kabupaten Way Kanan", State = States.Single(m => m.StateName == "Lampung") },
                

                new City { CityName = "Kota Ambon", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kabupaten Buru", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kabupaten Buru Selatan", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kabupaten Kepulauan Aru", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kabupaten Maluku Barat Daya", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kabupaten Maluku Tengah", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kabupaten Maluku Tenggara", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kabupaten Maluku Tenggara Barat", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kabupaten Seram Bagian Barat", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kabupaten Seram Bagian Timur", State = States.Single(m => m.StateName == "Maluku") },
                new City { CityName = "Kota Tual", State = States.Single(m => m.StateName == "Maluku") },
                

                new City { CityName = "Kabupaten Halmahera Barat", State = States.Single(m => m.StateName == "Maluku Utara") },
                new City { CityName = "Kabupaten Halmahera Selatan", State = States.Single(m => m.StateName == "Maluku Utara") },
                new City { CityName = "Kabupaten Halmahera Tengah", State = States.Single(m => m.StateName == "Maluku Utara") },
                new City { CityName = "Kabupaten Halmahera Timur", State = States.Single(m => m.StateName == "Maluku Utara") },
                new City { CityName = "Kabupaten Halmahera Utara", State = States.Single(m => m.StateName == "Maluku Utara") },
                new City { CityName = "Kabupaten Halmahera Sula", State = States.Single(m => m.StateName == "Maluku Utara") },
                new City { CityName = "Kabupaten Pulau Morotal", State = States.Single(m => m.StateName == "Maluku Utara") },
                new City { CityName = "Kota Ternate", State = States.Single(m => m.StateName == "Maluku Utara") },
                new City { CityName = "Kota Tidore Kepulauan", State = States.Single(m => m.StateName == "Maluku Utara") },
                

                new City { CityName = "Kabupaten Aceh Barat", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Barat Daya", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Besar", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Jaya", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Selatan", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Singkil", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Tamiang", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Tengah", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Tenggara", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Timur", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Aceh Utara", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kota Banda Aceh", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Bener Meriah", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Bireuen", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Gayo Lues", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kota Langsa", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kota Lhokseumawe", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Nagan Raya", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Pidie", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Pidie Jaya", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kota Sabang", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kabupaten Simeulue", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                new City { CityName = "Kota Subulussalam", State = States.Single(m => m.StateName == "Nangroe Aceh Darussalam") },
                

                new City { CityName = "Kabupaten Bima", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                new City { CityName = "Kota Bima", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                new City { CityName = "Kabupaten Dompu", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                new City { CityName = "Kabupaten Lombok Barat", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                new City { CityName = "Kabupaten Lombok Tengah", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                new City { CityName = "Kabupaten Lombok Timur", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                new City { CityName = "Kabupaten Lombok Utara", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                new City { CityName = "Kota Mataram", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                new City { CityName = "Kabupaten Sumbawa", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                new City { CityName = "Kabupaten Sumbawa Barat", State = States.Single(m => m.StateName == "Nusa Tenggara Barat") },
                

                new City { CityName = "Kabupaten Alor", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Belu", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Ende", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Flores Timur", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Kupang", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kota Kupang", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Lembata", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Manggarai", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Manggarai Barat", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Manggarai Timur", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Nagekeo", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Ngada", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Rote Ndao", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Sabu Raijua", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Sikka", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Sumba Barat", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Sumba Barat Daya", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Sumba Tengah", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Sumba Timur", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Timor Tengah Selatan", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                new City { CityName = "Kabupaten Timor Tengah Utara", State = States.Single(m => m.StateName == "Nusa Tenggara Timur") },
                

                new City { CityName = "Kabupaten Asmat", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Biak Numfor", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Boven Digoel", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Deiyai", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Dogiyai", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Intan Jaya", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Jayapura", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kota Jayapura", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Jayawijaya", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Keerom", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Kepulauan Yapen", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Lanny Jaya", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Mamberamo Raya", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Mamberamo Tengah", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Mappi", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Merauke", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Mimika", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Nabire", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Nduga", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Paniai", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Pengunungan Bintang", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Puncak", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Puncak Jaya", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Sarmi", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Supiori", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Tolikara", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Waropen", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Yahukimo", State = States.Single(m => m.StateName == "Papua") },
                new City { CityName = "Kabupaten Yalimo", State = States.Single(m => m.StateName == "Papua") },
                

                new City { CityName = "Kabupaten Fakfak", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Kalimana", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Manokwari", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Manokwari Selatan", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Maybrat", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Pegunungan Arfak", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Raja Ampat", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Sorong", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kota Sorong", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Sorong Selatan", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Tambrauw", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Teluk Bintuni", State = States.Single(m => m.StateName == "Papua Barat") },
                new City { CityName = "Kabupaten Teluk Wondama", State = States.Single(m => m.StateName == "Papua Barat") },
                

                new City { CityName = "Kabupaten Bengkalis", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kota Dumai", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kabupaten Indragiri Hilir", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kabupaten Indragiri Hulu", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kabupaten Kampar", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kabupaten Kepulauan Meranti", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kabupaten Kuantan Singingi", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kota Pekanbaru", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kabupaten Pelalawan", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kabupaten Rokan Hilir", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kabupaten Rokan Hulu", State = States.Single(m => m.StateName == "Riau") },
                new City { CityName = "Kabupaten Siak", State = States.Single(m => m.StateName == "Riau") },
                

                new City { CityName = "Kabupaten Majene", State = States.Single(m => m.StateName == "Sulawesi Barat") },
                new City { CityName = "Kabupaten Mamasa", State = States.Single(m => m.StateName == "Sulawesi Barat") },
                new City { CityName = "Kabupaten Mamuju", State = States.Single(m => m.StateName == "Sulawesi Barat") },
                new City { CityName = "Kabupaten Mamuju Utara", State = States.Single(m => m.StateName == "Sulawesi Barat") },
                new City { CityName = "Kabupaten Polewali Mandar", State = States.Single(m => m.StateName == "Sulawesi Barat") },
                

                new City { CityName = "Kabupaten Bantaeng", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Barru", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Bone", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Bulukumba", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Enrekang", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Gowa", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Jeneponto", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Luwu", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Luwu Timur", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Luwu Utara", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kota Makassar", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Maros", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kota Palopo", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Pangkajene Kepulauan", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kota Parepare", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Pinrang", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Selayar", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Sidenreng Rappang", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Sinjai", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Soppeng", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Takalar", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Tana Toraja", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Toraja Utara", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                new City { CityName = "Kabupaten Wajo", State = States.Single(m => m.StateName == "Sulawesi Selatan") },
                

                new City { CityName = "Kabupaten Banggai", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kabupaten Banggai Kepulauan", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kabupaten Buol", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kabupaten Donggala", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kabupaten Morowali", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kota Palu", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kabupaten Parigi Moutong", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kabupaten Poso", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kabupaten Sigi", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kabupaten Tojo Una-Una", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                new City { CityName = "Kabupaten Toli-Toli", State = States.Single(m => m.StateName == "Sulawesi Tengah") },
                

                new City { CityName = "Kota Bau-Bau", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Bombana", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Buton", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Buton Utara", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kota Kendari", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Kolaka", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Kolaka Utara", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Konawe", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Konawe Selatan", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Konawe Utara", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Muna", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                new City { CityName = "Kabupaten Wakatobi", State = States.Single(m => m.StateName == "Sulawesi Tenggara") },
                

                new City { CityName = "Kota Bitung", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Bolaang Mongondow (Bolmong)", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Bolaang Mongondow Selatan", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Bolaang Mongondow Timur", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Bolaang Mongondow Utara", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Kepulauan Sangihe", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Siau Tagulandang Biaro (Sitaro)", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Kepulauan Talaud", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kota Kotamobagu", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kota Manado", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Minahasa", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Minahasa Selatan", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Minahasa Tenggara", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kabupaten Minahasa Utara", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                new City { CityName = "Kota Tomohon", State = States.Single(m => m.StateName == "Sulawesi Utara") },
                

                new City { CityName = "Kabupaten Agam", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kota Bukittinggi", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Dharmasraya", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Kepulauan Mentawai", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Lima Puluh Koto/Kota", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kota Padang", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kota Padang Panjang", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Padang Pariaman", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kota Pariaman", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Pasaman", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Pasaman Barat", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kota Pakumbuyuh", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Pesisir Selatan", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kota Sawah Lunto", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Sijunjung", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Solok", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kota Solok", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Solok Selatan", State = States.Single(m => m.StateName == "Sumatera Barat") },
                new City { CityName = "Kabupaten Tanah Datar", State = States.Single(m => m.StateName == "Sumatera Barat") },
                

                new City { CityName = "Kabupaten Banyuasin", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Empat Lawang", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Lahat", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kota Lubuk Linggau", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Muara Enim", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Musi Banyuasin", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Musi Rawas", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Ogan Ilir", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Ogan Komering Ilir", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Ogan Komering Ulu", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Ogan Komering Ulu Selatan", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kabupaten Ogan Komering Ulu Timur", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kota Pagar Alam", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kota Palembang", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                new City { CityName = "Kota Prabumulih", State = States.Single(m => m.StateName == "Sumatera Selatan") },
                

                new City { CityName = "Kabupaten Asahan", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Batu Bara", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kota Binjai", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Dairi", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Deli Serdang", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kota Gunungsitoli", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Humbang Hasundutan", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Karo", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Lebuhan Batu", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Lebuhan Batu Selatan", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Lebuhan Batu Utara", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Langkat", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Mandailing Natal", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kota Medan", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Nias", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Nias Barat", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Nias Selatan", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Nias Utara", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Padang Lawas", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Padang Lawas Utara", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kota Padang Sidempuan", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Pakpak Bharat", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kota Pematang Siantar", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Samosir", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Serdang Bedagai", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kota Sibolga", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Simalungun", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kota Tanjung Balai", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Tapanuli Selatan", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Tapanuli Tengah", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Tapanuli Utara", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kota Tebing Tinggi", State = States.Single(m => m.StateName == "Sumatera Utara") },
                new City { CityName = "Kabupaten Toba Samosir", State = States.Single(m => m.StateName == "Sumatera Utara") },
