    ...
    public class InitialData : DropCreateDatabaseIfModelChanges<NamaskaraDb>
    {
        protected override void Seed(NamaskaraDb context)
        {
            ...
            List<Product> Products = new List<Product>
            {
                ...
                new Product { Name =  "Edensoy Blend Rice & Soy", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "", Origin = ""},
                new Product { Name =  "Edensoy Extra Original", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "", Origin = ""},
                ...
                new Product { Name =  "PURE HARVEST (Brown Rice Milk)", Category = Categories.Single(c => c.Name == "Milk"), Packaging = PackagingEnum.Carton, ImageUrl = "", Origin = ""},
                ...
                new Product { Name =  "DR. Broners Lotion", Category = Categories.Single(c => c.Name == "Toiletries"), Packaging = PackagingEnum.Bottle, ImageUrl = "dr bronners magic lotion", Origin = ""},
                new Product { Name =  "DR. Broners Skin & Tattoo Balm", Category = Categories.Single(c => c.Name == "Toiletries"), ImageUrl = "dr bronners body balm", Origin = ""},
